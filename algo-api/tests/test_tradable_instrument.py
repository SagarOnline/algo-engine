...
from algo.domain.strategy.strategy import Instrument, Segment, TradeAction
from algo.domain.strategy.tradable_instrument import TradableInstrument, TriggerType

def make_instrument():
    return Instrument(segment= Segment.EQ, exchange= "NSE", instrument_key= "NSE_TEST_INSTRUMENT" )
